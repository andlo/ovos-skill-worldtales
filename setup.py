...
URL = "https://github.com/andlo/ovos-skill-worldtales"
SKILL_CLAZZ = "WorldTales"  # needs to match __init__.py class name
PYPI_NAME = "ovos-skill-worldtales"  # pip install PYPI_NAME
...
setup(
    name=PYPI_NAME,
    version=get_version(),
    description="OVOS skill that tells classic fairy tales and folklore from around the world, sourced from Project Gutenberg",
    ...
    keywords="ovos skill voice assistant gutenberg fairytales folklore",
